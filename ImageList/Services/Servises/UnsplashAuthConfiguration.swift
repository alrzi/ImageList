...
private let DefaultBaseHost = "api.unsplash.com"
private let UnsplashAuthorizeURLString = "https://unsplash.com/oauth/authorize"
private let UnsplashTokenURLString = "https://unsplash.com/oauth/token"

enum OAuthConfigurationProvider {
    #if DEBUG
    private static let authConfiguration: UnsplashAuthConfiguration = .standard
    #else
    private static let authConfiguration: UnsplashAuthConfiguration = .standard
    #endif
        
    static var config: UnsplashAuthConfiguration { authConfiguration }
}
