...
final class DetailImagesListViewController: UIViewController {
    ...
    private let scribbleImageView: UIImageView = {
        let image = UIImageView(image: UIImage(resource: ._10ScribbleVariable))
        image.translatesAutoresizingMaskIntoConstraints = false
        return image
    }()
    ...
    private lazy var shareButton: UIButton = {
        ...
        shareButton.setImage(UIImage(resource: ._09Sharing), for: .normal)
    ...
    let presenter: DetailImageListPresenterProtocol
...
private extension DetailImagesListViewController {
    ...
    func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            blurredBackgroundBackButtonView.leadingAnchor.constraint(
                equalTo: view.safeAreaLayoutGuide.leadingAnchor,
                constant: 16
            ),
            blurredBackgroundBackButtonView.topAnchor.constraint(
